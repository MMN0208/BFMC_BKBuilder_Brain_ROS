...
IMG_SRC =  '/home/quangngcs/Desktop/Github/BFMC_BKBuilder_Brain_ROS/src/perception/lane_detection/frame_test/bfmc_bkhouse_640.png'
W, H = IMG_SIZE
# wTop =  489 
# hTop =  0    
# wBot =  153
...
params_processing['src_points'] = np.array([[0, 315], [535,  318], [428, 213], [125, 207]], dtype=np.float32) 
